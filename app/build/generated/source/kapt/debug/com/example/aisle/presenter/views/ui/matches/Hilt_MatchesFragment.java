 ...
 */
public abstract class Hilt_MatchesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MatchesFragment() {
    super();
  }

  Hilt_MatchesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MatchesFragment_GeneratedInjector) this.generatedComponent()).injectMatchesFragment(UnsafeCasts.<MatchesFragment>unsafeCast(this));
    }
  }
